...
<div id="top-banners">
    <div class="top-banner-fream">
        <img src="images/banner/b.jpg" width="1200" height="250">
    </div>
</div>
...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" id="delete"></a>
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" id="deleteall">delete all</a>
   </div>
                        ...
                        <div class="sub-container-info">
                            <div class="info">
                                ...
                                <div class="footer-links">
                                    ...
                                    <span class="link-style"><a href="FaQ.html">News & Events</a></span><br><br>
